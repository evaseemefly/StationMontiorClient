 ...
 * 海浪bar(方向)配置
 */
class WaveBarOptType {
	public forecastTimestamp: string
	public issueTimestamp: string
	public step: number
	 ...
	 * @author evaseemefly
	 * @date 2023/01/16
	 * @param {string} forecastTimestamp 预报时间戳
	 * @param {string} issueTimestamp 发布时间戳
	 * @param {number} step 步长
	 * @memberof WaveBarOptType
	 */
	constructor(forecastTimestamp: string, issueTimestamp: string, step: number) {
...
export { CoverageDetailMidModel, WMSOptionsMidModel, WMSMidModel, WaveBarOptType }
