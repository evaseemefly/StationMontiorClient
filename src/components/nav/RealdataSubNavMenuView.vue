<template>
	<nav id="sub_nav_menu">
		...
		<SubNavDateRangeMenuView></SubNavDateRangeMenuView>
	</nav>
</template>
<script lang="ts">
...
import SubNavDateRangeMenuView from '@/components/nav/subItems/SubNavDaterangeMenu.vue'
...
@Component({
	components: {
		...
		SubNavTimespanItem,
		SubNavTemp,
		SubNavDateRangeMenuView,
	},
})
export default class RealdataSubNavMenuView extends Vue {
	/** 是否圈选 */
